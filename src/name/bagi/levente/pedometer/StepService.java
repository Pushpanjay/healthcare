...
public class StepService extends Service {
    ...
    public void onCreate() {
        ...
        Toast.makeText(this, getText(com.example.healthcare.R.string.started), Toast.LENGTH_SHORT).show();
    }
    ...
    public void onDestroy() {
        ...
        mNM.cancel(com.example.healthcare.R.string.app_name);
        ...
        Toast.makeText(this, getText(com.example.healthcare.R.string.stopped), Toast.LENGTH_SHORT).show();
    }
    ...
    private void showNotification() {
        CharSequence text = getText(com.example.healthcare.R.string.app_name);
        Notification notification = new Notification(com.example.healthcare.R.drawable.ic_notification, null,
        ...
        notification.setLatestEventInfo(this, text,
                getText(com.example.healthcare.R.string.notification_subtitle), contentIntent);

        mNM.notify(com.example.healthcare.R.string.app_name, notification);
    }
